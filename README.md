...
{
  "dependencies": {
    "com.tripledot.canvaskit": "https://github.com/robertcarone-dev/com.tripledot.canvaskit.git#v0.4.6-preview"
  }
}
```
...
Release tags use the package version with a leading `v`, for example `v0.4.6-preview` for package version `0.4.5-preview`.
